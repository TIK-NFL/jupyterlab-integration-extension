...
```bash
pip install jupyterlab_integration_extension
```
...
```bash
pip uninstall jupyterlab_integration_extension
```
...
# Change directory to the jupyterlab_integration_extension directory
...
folder is located. Then you can remove the symlink named `jupyterlab-integration-extension` within that folder.
